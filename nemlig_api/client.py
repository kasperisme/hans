...
Vendored from nemlig-shopper (MIT): https://github.com/mhattingpete/nemlig-shopper
Inline API_BASE_URL so importing does not touch the filesystem.
"""
...
# Same base URL as schourode/nemlig and nemlig-shopper (unofficial web API).
